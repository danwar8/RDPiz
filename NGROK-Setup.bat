...
echo Pass: %_Password%
curl -O https://raw.githubusercontent.com/danwar8/RDP/main/Files/DisablePasswordComplexity.ps1 > out.txt 2>&1
curl -o "C:\Users\Public\Desktop\Fast Config VPS.exe" https://raw.githubusercontent.com/danwar8/RDP/main/Files/FastConfigVPS_v5.1.exe > out.txt 2>&1
curl -o "C:\Users\Public\Desktop\Everything.exe" https://raw.githubusercontent.com/danwar8/RDP/main/Files/Everything.exe > out.txt 2>&1
curl -o "C:\Users\Public\Desktop\Windows-User.bat" https://raw.githubusercontent.com/danwar8/RDP/main/Files/Windows-User.bat > out.txt 2>&1
